export default {
  ...
  error_page: {
    '404': {
      ...
      subtitle:
        'Страница, которую вы ищете, не существует. Возможно, она была удалена, переименована или вы ввели неправильный адрес.',
      title: 'Здесь ничего нет.',
    },
    '500': {
      button_text: 'Вернуться на главную страницу.',
      subtitle: 'Произошла непредвиденная ошибка при обработке вашего запроса. Пожалуйста, попробуйте позже.',
