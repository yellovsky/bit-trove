...
export function findNodePosition(props: {
  ...
  if (hasValidPos) {
    try {
      ...
      if (nodeAtPos) {
        return { node: nodeAtPos, pos: nodePos };
      }
    } catch (error) {
  ...
  return foundPos !== -1 && foundNode !== null ? { node: foundNode, pos: foundPos } : null;
}
...
const ATTR_WHITESPACE =
  ...
  // biome-ignore lint/suspicious/noControlCharactersInRegex: by design
  /[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g;
