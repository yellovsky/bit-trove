...
export class ShortThoughtDto implements ShortThought {
  @ApiProperty({
  ...
  static fromModel(model: LocalizedShortThoughtModel): ShortThoughtDto {
    return new ShortThoughtDto({
