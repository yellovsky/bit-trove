...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    author: Attribute.Relation<'plugin::users-permissions.user', 'oneToOne', 'api::author.author'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiAuthorAuthor extends Schema.CollectionType {
  ...
  attributes: {
    ...
    user: Attribute.Relation<'api::author.author', 'oneToOne', 'plugin::users-permissions.user'>;
    blog_posts: Attribute.Relation<'api::author.author', 'oneToMany', 'api::blogpost.blogpost'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiBlogpostBlogpost extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::blogpost.blogpost', 'oneToOne', 'admin::user'> &
      Attribute.Private;
...
export interface ApiQuickCategoryQuickCategory extends Schema.SingleType {
  collectionName: 'quick_categories';
  info: {
    singularName: 'quick-category';
    pluralName: 'quick-categories';
    displayName: 'Quick Category';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    categories: Attribute.Relation<
      'api::quick-category.quick-category',
      'oneToMany',
      'api::category.category'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::quick-category.quick-category', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::quick-category.quick-category', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    localizations: Attribute.Relation<
      'api::quick-category.quick-category',
      'oneToMany',
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::quick-category.quick-category': ApiQuickCategoryQuickCategory;
